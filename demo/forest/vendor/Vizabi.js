...
(function (global, factory) {
...
})(this, (function (mobx, d3) { 'use strict';
  ...
  */
  ...
  // simple, fast filtering using function that checks for nullish value
  function fieldsNullishCheck(fields) {
      const l = fields.length;
      return row => {
          //faster implementation with a for-loop
          for (let i = 0; i < l; i++) {
  ...
  */
  ...
  filter.nonObservable = function (config, parent, id) {
      ...
      return {
          ...
          */
          ...
          addUsingLimitedStructure: mobx.action("addUsingLimitedStructure", function (vectorisedParams) {  
          ...
          deleteUsingLimitedStructure: mobx.action("deleteUsingLimitedStructure", function (vectorisedParams) {
              const unpackedParams = cartesianPermutations(vectorisedParams);
          ...
          switchIsenssUsingLimitedStructure: mobx.action("switchIsenssUsingLimitedStructure", function({dim, isness}){
      ...
      return {
          ...
          getColorShade({colorID, shadeID = "shade"}) {
              ...
              return shadeID === "shade" 
                  ? d3.rgb(palette[colorID] || this.parent.d3Scale(colorID)).darker(0.5).toString() 
                  : color;
          },
  ...
  marker.nonObservable = function(config, parent, id) {
      ...
      const functions = {
          ...
          get requiredFields() {
              return mobx.toJS(this.config.requiredFields || defaults.requiredFields);
          },
