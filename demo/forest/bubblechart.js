...
`;const G=class G extends k._TextBackgroundLayer{initializeState(){super.initializeState(),this.getAttributeManager().addInstanced({instanceDragged:{size:1,transition:!1,accessor:"getDragged"}})}draw(e){const{cornerRadius:t=0}=this.props,{edgeMaxCoord:i=1}=this.parent.props;e.uniforms.cornerRadius=t,e.uniforms.edgeMaxCoord=i,super.draw(e)}getShaders(){return{...super.getShaders(),vs:we,fs:Te}}};x(G,"LabelBackgroundLayer"),U(G,"defaultProps",{getDragged:{type:"accessor",value:0}});let j=G;var Pe=`#version 300 es
