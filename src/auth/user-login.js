export default function UserLogin(selecrtor, supabaseClient) {  

  const placeHolder = d3.select(selecrtor);
      ...
      <div class="user-login-form">
        ...
        <span>
          ...
          <form class="panel login-panel">
            ...
            <span class="button button-switch-signup"><a>Create account</a></span>
          </form>
        </span>
      </div>
    </div>
